...
class AdminMealTrackerScreen extends StatefulWidget {
  const AdminMealTrackerScreen({super.key});

  @override
  State<AdminMealTrackerScreen> createState() => _AdminMealTrackerScreenState();
}

class _AdminMealTrackerScreenState extends State<AdminMealTrackerScreen> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Meal Analytics", style: TextStyle(color: Color(0xFF4F8FE0))),
      ),
      body: vm.isLoading
                      ...
                      return Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(child: Text("User ${vm.maskId(entry["userId"])} — ${entry["mealCount"]} meals", style: const TextStyle(fontSize: 12))),
