          ...
          children: [
            ...
            if (vm.dehydrationRiskRate > 0)
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFFFF7D7D).withOpacity(0.4)),
                  boxShadow: [
                    BoxShadow(color: const Color(0xFFFF7D7D).withOpacity(0.1), blurRadius: 10, offset: const Offset(0, 4)),
                  ],
                ),
                child: Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(color: const Color(0xFFFF7D7D).withOpacity(0.2), shape: BoxShape.circle),
                      child: const Icon(Icons.warning_amber_rounded, color: Color(0xFFFF7D7D), size: 24),
                    ),
                    ...
                    Expanded(
                      child: Text(
                        ...
                        style: const TextStyle(fontSize: 14, color: Color(0xFFC62828), fontWeight: FontWeight.w600, height: 1.4),
                      ),
                    ),
                  ],
                ),
            ...
            GridView.count(
              ...
              children: [
                ...
                _statCard(Icons.assignment, const Color(0xFF9B7FE8), "Total Entries", "${vm.waterEntries}"),
                ...
                _statCard(Icons.emoji_events, const Color(0xFFEF8FA8), "Goal Met Today", "${vm.usersMetGoalToday}"),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text("Hydration Trend (7 days)", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF2A2A2A))),
                  const SizedBox(height: 20),
                  SizedBox(
                    height: 160,
                    child: LineChart(
                          ...
                          LineChartBarData(
                            ...
                            dotData: FlDotData(
                              ...
                              getDotPainter: (spot, percent, barData, index) => FlDotCirclePainter(
                                  radius: 4, color: Colors.white, strokeWidth: 2, strokeColor: const Color(0xFF6FC3F7)
                              ),
                            ),
                  ...
                  const Text("Average daily intake (L) across all users", style: TextStyle(fontSize: 11, color: Colors.grey, fontWeight: FontWeight.w500)),
                ],
              ),
            ),
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Lowest Intake Users", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF2A2A2A))),
                          ...
                          child: Row(
                            children: [
                              Container(
                                ...
                                child: const Icon(Icons.person, size: 18, color: Color(0xFF4F8FE0)),
                              ),
                              const SizedBox(width: 12),
                              Expanded(child: Text("User ${vm.maskId(u['userId'])}", style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w600, color: Color(0xFF2A2A2A)))),
                              Container(
                                padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                                decoration: BoxDecoration(color: const Color(0xFFFFF0F0), borderRadius: BorderRadius.circular(10)),
                                child: Text("${u['intake']} L", style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Color(0xFFFF7D7D))),
                              ),
                            ],
                          ),
                        ),
                      ...
                      return Padding(
                        ...
                        child: Row(
                          children: [
                            Container(
                              padding: const EdgeInsets.all(8),
                              decoration: BoxDecoration(color: const Color(0xFF6FC3F7).withOpacity(0.15), shape: BoxShape.circle),
                              child: const Icon(Icons.water_drop, size: 20, color: Color(0xFF6FC3F7)),
                            ),
                            const SizedBox(width: 12),
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text("${entry['intake']} ml", style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xFF6FC3F7))),
                                ],
                              ),
                            ),
