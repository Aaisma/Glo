                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          periodViewModel.cycleDay != null
                              ? "DAY ${periodViewModel.cycleDay}"
                              : "DAY --",
                            ...
                            Text(
                                periodViewModel.predictionDate != null
                                    ? DateFormat('MMMM dd, yyyy')
                                        .format(periodViewModel.predictionDate!)
                        ...
                        switch (item["title"]) {
                          ...
                          case "Skin Tracker":
                            Navigator.push(context,
                                MaterialPageRoute(builder: (_) => const AcneTrackerPage()));
                            break;
                          case "Visit Derma":
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) =>
                                        DermaVisitScreen(userId: user?.id ?? '123')));
                            break;
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (_) => const LogSymptomsPage(isPeriod: false)),
                    ),
                    child: const Text(
                      "Log Symptoms +",
